...
import icon1 from '../../Assets/SVGs/edit.svg';
import ecllipse2 from '../../Assets/SVGs/ellipse-2.svg'
import line70 from '../../Assets/SVGs/line-70.svg'
import link2 from '../../Assets/SVGs/link-2.svg';
import activityicon from '../../Assets/SVGs/activity.svg';
...
const DataTable: React.FunctionComponent<IDataTableProps> = (props) => {
  ...
  return (
    <>
    <div className=" mx-auto pt-2 pb-10 datatable">
        ...
        <div className="headers">
          ...
          <div className="text-section">
            <h1 className="section3-header">
              Why choose <span className="text-style">Scissors</span>
            </h1>
            <p className="section3-subheader">
        ...
        <div className="all-items">
          <div className="section3-items">
            <div className="section3-item">
              ...
              <h1 className="item-header">URL Shortening</h1>
            ...
            <div className="section3-item">
              ...
              <h1 className="item-header">Custom URLs</h1>
              <p className="item-subheader">
          ...
          <div className="section3-items">
            <div className="section3-item">
              ...
              <h1 className="item-header">QR Codes</h1>
              <p className="item-subheader">
            ...
            <div className="section3-item">
              ...
              <h1 className="item-header">Data Analytics</h1>
              <p className="item-subheader">
